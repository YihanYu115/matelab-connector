...
2. Run `matelab-bridge auth login USERNAME`; the password is requested with hidden input and is never stored.
3. Run `matelab-bridge doctor --online`.
4. Start `matelab-bridge serve` under the chosen Windows service supervisor.
